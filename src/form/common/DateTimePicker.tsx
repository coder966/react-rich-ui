...
class DateTimePicker extends React.Component<DateTimePickerProps, DateTimePickerState> {
  constructor(props: DateTimePickerProps) {
    ...
    const todayH = new Intl.DateTimeFormat('en-US-u-ca-islamic', { day: 'numeric', month: 'numeric', year: 'numeric' })
      .format(Date.now())
      .replace(' AH', '')
      .split('/');
  ...
  componentDidUpdate = (prevProps: any, prevState: any) => {
    ...
    if (this.props.onChange) {
      if (
        ...
        (!prevState || prevState.day !== day || prevState.month !== month || prevState.year !== year)
      ) {
  ...
  getYears = (): string[] =>
    this.props.isHijri
      ? this.range(this.state.minYearH, this.state.maxYearH)
      : this.range(this.state.minYearG, this.state.maxYearG);
